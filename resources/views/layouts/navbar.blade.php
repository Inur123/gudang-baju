      ...
      <div class="relative user-dropdown-container">
        <div class="flex items-center gap-2 cursor-pointer" id="userDropdownToggle">
          <div class="relative">
            ...
            <img
              src="https://ui-avatars.com/api/?name=Sarah+Johnson&background=f9a8d4&color=fff"
              alt="User Avatar"
              class="h-8 w-8 rounded-full border-2 border-pink-200"
            >
          </div>
        ...
        <div id="userDropdown" class="user-dropdown bg-white rounded-lg shadow-lg border border-gray-200 w-48 py-1">
          ...
          <a href="login.html" class="block px-4 py-2 text-sm text-red-600 hover:bg-pink-50">
